...
export const metadata: Metadata = {
  ...
  description: "Krátký dotazník a katalog anglických bakalářských, AP, Top-up a magisterských programů v Dánsku.",
};
  ...
  return <main id="hlavni-obsah">
    <section className="page-hero shell">
      <div className="page-hero-grid">
        ...
        <p className="lead">Odpověz na několik krátkých otázek. Ukážeme ti skutečné bakalářské, AP, Top-up a magisterské programy a vysvětlíme, proč odpovídají tvým zájmům.</p>
      </div>
    </section>
